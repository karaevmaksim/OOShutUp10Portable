...
user in an INI file next to OOShutUp10Portable.exe called OOShutUp10Portable.ini.
...
copy AppNamePortable.ini from this directory to OOShutUp10Portable.ini next to
OOShutUp10Portable.exe. The options in the INI file are as follows:
